    ...
    <div className="bg-black text-white py-16 px-4 md:px-8 lg:px-16 min-h-screen flex flex-col items-center mt-10 w-[98%] rounded-3xl m-auto">
      ...
      <div className="text-center mb-8">
        <div className="inline-flex items-center justify-center mb-8">
          {/* Left Line with clip-path and gradient */}
          <div className="h-[2px] w-10 bg-gradient-to-r from-transparent via-blue-500 to-transparent relative">
            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-blue-500 to-transparent blur-sm opacity-50 clip-diagonal"></div>
          </div>
